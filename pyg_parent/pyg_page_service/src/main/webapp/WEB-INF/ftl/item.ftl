...
<#-- 规格-->
<#assign specAttributeList=tbGoodsDesc.specificationItems?eval>
<!--页面顶部 结束-->
    ...
    <div id="item">
        <div class="crumb-wrap">
            <ul class="sui-breadcrumb">
                <li>
                    <a href="#">${tbItemCat1Name}</a>
                </li>
                <li>
                    <a href="#">${tbItemCat2Name}</a>
                </li>
                <li>
                    <a href="#">${tbItemCat3Name}</a>
                </li>
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        <#list specAttributeList as specAttribute>
                            <dl>
                                <dt>
                                    <div class="fl title">
                                        <i>${specAttribute.attributeName}</i>
                                    </div>
                                </dt>
                                <#list specAttribute.attributeValue as item>
                                    <dd><a href="javascript:;" class="{{isSelect('${specAttribute.attributeName}','${item}')?'selected':''}}" ng-click="selectSpecification('${specAttribute.attributeName}','${item}')">${item}<span  title="点击取消选择">&nbsp;</span></a></dd>
                                </#list>
                            </dl>
                        </#list>
                    </div>
